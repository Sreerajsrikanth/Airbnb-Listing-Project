This R Markdown file contains each step of the project, From importing Libraries till creating a baseline model for the same. It essentially covers 3 aspects:
